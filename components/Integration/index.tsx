        ...
        <div className="max-w-c-1390 mx-auto px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              description: `Whether you're in the office or on the go, our solution empowers you to remotely manage and maintain your data securely. Stay in control, access critical information, and ensure smooth operations no matter where you are, anytime you need it.`,
            }}
          />
